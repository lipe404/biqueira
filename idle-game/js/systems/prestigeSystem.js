...
export const PrestigeSystem = {
    ...
    prestige: () => {
        ...
        if (confirm(`Tem certeza de que deseja virar Patrão? Você vai zerar o caixa e a mercadoria, mas vai ganhar ${gain} de Respeito (Influência). Isso aumenta seus lucros permanentemente.`)) {
